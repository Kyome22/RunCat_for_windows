    ...
    public class RunCatApplicationContext : ApplicationContext
    {
        ...
        public RunCatApplicationContext()
        {
            ...
            runnerMenu = new ToolStripMenuItem("Runner", null, new ToolStripMenuItem[]
            {
                ...
                {
                    Checked = runner.Equals("party parrot")
                }
            });
        ...
        private void SetIcons()
        {
            ...
            int capacity = 5;
            if (runner.Equals("parrot") || runner.Equals("party parrot"))
            {
                capacity = 10;
            }
            ...
            {
                if (runner.Equals("party parrot"))
                {
                    list.Add((Icon)rm.GetObject($"party_parrot_{i}"));
                }
                else
                {
